...
const seedStops: Stop[] = [
  { id: 'mm', name: 'Music Millennium', kind: 'record', neighborhood: 'Laurelhurst', lng: -122.639, lat: 45.522, rating: 4.7, hours: 'Open · Closes 7 PM', specialty: 'New releases · Local artists', photo: '🎧', description: 'An all-purpose Portland institution with deep new-vinyl bins and an excellent local music wall.', rank: 5, note: 'Check new arrivals + Portland section' },
  { id: 'lr', name: 'Little Axe Records', kind: 'record', neighborhood: 'Northwest', lng: -122.694, lat: 45.532, rating: 4.8, hours: 'Opens 11 AM', specialty: 'Soul · Jazz · Rare groove', photo: '💿', description: 'Small, selective shop for adventurous digging: private press, international funk, and heavyweight jazz.', rank: 4 },
  { id: 'ec', name: 'Everyday Music', kind: 'record', neighborhood: 'Hawthorne', lng: -122.623, lat: 45.512, rating: 4.5, hours: 'Open · Closes 8 PM', specialty: 'Used vinyl · CDs · Books', photo: '📀', description: 'A high-volume used-media stop where patient crate digging pays off.' },
  { id: 'mr', name: 'Mississippi Records', kind: 'record', neighborhood: 'Boise', lng: -122.675, lat: 45.551, rating: 4.8, hours: 'Open · Closes 7 PM', specialty: 'Folk · Blues · Global', photo: '🪕', description: 'Beautifully curated records, reissues, and esoteric gems from around the world.' },
  { id: 'lu', name: 'Lúc Lác', kind: 'food', neighborhood: 'Downtown', lng: -122.678, lat: 45.518, rating: 4.6, hours: 'Open · Closes 10 PM', specialty: 'Vietnamese · Casual', photo: '🍜', description: 'Fast Vietnamese comfort food; great for an easy midday reset.', meal: 'Lunch', rank: 4 },
  { id: 'jo', name: 'Janken', kind: 'food', neighborhood: 'Pearl District', lng: -122.683, lat: 45.528, rating: 4.5, hours: 'Dinner from 5 PM', specialty: 'Japanese · Steakhouse', photo: '🍣', description: 'A polished dinner option close to Northwest digging.', meal: 'Dinner', rank: 3 }
]
