...
const seedStops: Stop[] = [
  ...
  { id: 'sde', name: 'Screen Door Eastside', kind: 'food', neighborhood: 'Kerns', lat: 45.523017, lng: -122.641625, rating: 4.7, hours: 'Daily 8:30 AM–2 PM · 4:30–9:30 PM', specialty: 'Southern comfort · Fried chicken', photo: '🍗', meal: 'Lunch', description: '0.5 mi from Music Millennium — Southern brunch and fried chicken in a lively room.' },
